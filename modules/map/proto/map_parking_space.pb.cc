...
const char descriptor_table_protodef_modules_2fmap_2fproto_2fmap_5fparking_5fspace_2eproto[] =
...
class ParkingSpace::HasBitSetters {
 public:
...
ParkingSpace::HasBitSetters::id(const ParkingSpace* msg) {
  return *msg->id_;
}
const ::apollo::hdmap::Polygon&
ParkingSpace::HasBitSetters::polygon(const ParkingSpace* msg) {
  return *msg->polygon_;
}
...
class ParkingLot::HasBitSetters {
 public:
...
const ::apollo::hdmap::Id&
ParkingLot::HasBitSetters::id(const ParkingLot* msg) {
  return *msg->id_;
}
const ::apollo::hdmap::Polygon&
ParkingLot::HasBitSetters::polygon(const ParkingLot* msg) {
  return *msg->polygon_;
}
