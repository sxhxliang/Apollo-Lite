...
const char descriptor_table_protodef_modules_2fmap_2fproto_2fmap_5fclear_5farea_2eproto[] =
...
ClearArea::HasBitSetters::id(const ClearArea* msg) {
  return *msg->id_;
}
const ::apollo::hdmap::Polygon&
ClearArea::HasBitSetters::polygon(const ClearArea* msg) {
  return *msg->polygon_;
}
...
void ClearArea::SerializeWithCachedSizes(
  ...
  if (cached_has_bits & 0x00000002u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteMessageMaybeToArray(
      3, HasBitSetters::polygon(this), output);
  }
...
::PROTOBUF_NAMESPACE_ID::uint8* ClearArea::InternalSerializeWithCachedSizesToArray(
  ...
  if (cached_has_bits & 0x00000002u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(
        3, HasBitSetters::polygon(this), target);
  }
