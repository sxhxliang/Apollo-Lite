...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_RunModeConf_run_5fmode_5fconf_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_RunModeConf_run_5fmode_5fconf_2eproto}, {}};
...
const char descriptor_table_protodef_run_5fmode_5fconf_2eproto[] =
...
class RunModeConf::HasBitSetters {
 public:
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          ...
          if (PROTOBUF_PREDICT_TRUE(::apollo::cyber::proto::RunMode_IsValid(val))) {
            set_run_mode(static_cast<::apollo::cyber::proto::RunMode>(val));
          } else {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
          ...
          if (PROTOBUF_PREDICT_TRUE(::apollo::cyber::proto::ClockMode_IsValid(val))) {
            set_clock_mode(static_cast<::apollo::cyber::proto::ClockMode>(val));
          } else {
...
// @@protoc_insertion_point(message_byte_size_start:apollo.cyber.proto.RunModeConf)
  ...
  if (cached_has_bits & 0x00000003u) {
    ...
    if (cached_has_bits & 0x00000001u) {
      total_size += 1 +
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::EnumSize(this->run_mode());
    }

    // optional .apollo.cyber.proto.ClockMode clock_mode = 2 [default = MODE_CYBER];
    if (cached_has_bits & 0x00000002u) {
      total_size += 1 +
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::EnumSize(this->clock_mode());
    }
